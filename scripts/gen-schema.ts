// `pnpm schema`: writes contract/session.schema.json from the Zod schema in packages/core/src.
...
export const SCHEMA_FILE = join(dirname(fileURLToPath(import.meta.url)), '..', 'contract', 'session.schema.json');
